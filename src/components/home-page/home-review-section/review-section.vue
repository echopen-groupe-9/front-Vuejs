                        ...
                        <ul class="Home-review_carousel">
                            <li class="Home-review_holder" v-for="review in reviews">
                                <div class="Home-review_text">
                                    <h2 class="Home-review_title section-subtitle title">Highly <span
                                            class="section-subtitle-span">Manipulable</span></h2>
                                    >>>>>>> [Feat:RedesignHome] - Fix style on homepage
                                    <p class="Home-review_desc text">{{review.desc}}<span
                                            class="Home-review_desc--tiny"></span></p>
                                    <div class="Home-review--author"></div>
                                </div>
                                <div class="Home-review_holder--image">
                                    <img src="../../../assets/images/phone-graph.png" alt=""
                                         class="Home-review_image phone--image">
                                    <img src="../../../assets/images/echograpg-graph.png" alt=""
                                         class="Home-review_image echo--image">
                                </div>
                </div>
            </div>
    </section>
    ...
    export default {
        ...
        :
            'Highly Manipulable',
                desc
        :
            'Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Donec ullamcorper nulla non metus auctor fringilla. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Nulla vitae elit libero, a pharetra augue.'
        },
            {
                tab: 'Highly Noobish',
                    title
